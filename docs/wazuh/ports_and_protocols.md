...
```
curl -v https://wazuh-api.domain.com:55000/
```
...
```
nc -vz yourdomain.com 1514
nc -vz yourdomain.com 1515
```
 ...
 * Using curl:
```
curl -u <username>:<password> https://wazuh-api.domain.com:55000/
```
 * A successful response indicates proper HTTP/S handling.

 * Using openssl:
```
openssl s_client -connect wazuh-api.domain.com:55000
```
